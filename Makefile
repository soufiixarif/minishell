...
SRCS = sources/minishell.c sources/parser1.c sources/parser2.c sources/parser3.c sources/parser4.c sources/parser5.c sources/parser6.c sources/utils1.c sources/utils2.c sources/init.c sources/is_utils1.c sources/is_utils2.c sources/is_utils3.c sources/ft_getenv.c 
