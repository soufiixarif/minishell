...
SRCS = sources/minishell.c sources/parser1.c sources/parser2.c sources/parser3.c sources/parser4.c \
		sources/parser5.c sources/parser6.c sources/parser7.c sources/parser8.c sources/utils1.c sources/utils2.c sources/utils3.c sources/utils4.c sources/init.c sources/is_utils1.c \
